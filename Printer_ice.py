...
if 'PrinterPrx' not in _M_Demo.__dict__:
    ...
    class PrinterPrx(Ice.ObjectPrx):
        ...
        def countWords(self, s, context=None):
            return _M_Demo.Printer._op_countWords.invoke(self, ((s, ), context))

        def countWordsAsync(self, s, context=None):
            return _M_Demo.Printer._op_countWords.invokeAsync(self, ((s, ), context))

        def begin_countWords(self, s, _response=None, _ex=None, _sent=None, context=None):
            return _M_Demo.Printer._op_countWords.begin(self, ((s, ), _response, _ex, _sent, context))

        def end_countWords(self, _r):
            return _M_Demo.Printer._op_countWords.end(self, _r)
    ...
    Printer._op_countWords = IcePy.Operation('countWords', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), IcePy._t_int, False, 0), ())
